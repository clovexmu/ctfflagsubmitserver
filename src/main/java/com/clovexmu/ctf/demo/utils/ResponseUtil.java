...
public class ResponseUtil {
    ...
    public static <T> Object okList(Paging<T> paging){
        Map<String, Object> data = new HashMap<String, Object>();
        data.put("list", paging.getResult());
        data.put("total", paging.getTotalCount());
        data.put("page", paging.getCurrentPageNo() );
        data.put("limit", paging.getPageSize());
        data.put("pages", paging.getLastPageNo());
